// Créé des état dérivé, cest a dire qu'a partir de l'état de notre application, on créé d'autre état dérivé
export const calculateTotal = ($0, $1) => $0 + $1;    // calcul le total
