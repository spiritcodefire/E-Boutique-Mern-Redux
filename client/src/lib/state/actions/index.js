import {ADD_TO_CART,REMOVE_FROM_CART,SET_PAGE_INDEX,GET_PRODUCTS_PENDING,GET_PRODUCTS_SUCCESS,GET_PRODUCTS_FAILURE,UPDATE_CART,CHECKOUT,SET_DELIVERY_CHOICE,} from "./actionTypes";
...
// const returnProductsraguil = (items) => {
//         console.log(items);
// };

export function getProductsPending() { // prend les products en attente
  return {
